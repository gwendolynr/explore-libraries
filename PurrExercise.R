...
names(got_chars[[24]])
#playedby is last, or 18
map(got_chars, "playedBy")
tibble(map(got_chars, "playedBy"))
...
map_dfr(got_chars, `[`, c("name", "title"))
map(got_chars, `[`, c("name", "title")) 
tibble(
