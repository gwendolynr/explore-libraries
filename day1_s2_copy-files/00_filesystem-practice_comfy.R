...
list.files("~/Desktop/day1_s1_explore-libraries", pattern = "\\.R", full.names = TRUE)

from_files <- list.files("~/Desktop/day1_s1_explore-libraries", pattern = "\\.R", full.names = TRUE)
